...
export const en = {
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.kyc.identity.firstName.placeholder': 'Your name',
    'page.body.kyc.identity.lastName.placeholder': 'Your last name',
    'page.body.kyc.identity.dateOfBirth.placeholder': 'DD / MM / YY',
    'page.body.kyc.identity.CoR.placeholder': 'Select country',
    'page.body.kyc.identity.residentialAddress.placeholder': 'Your address',
    'page.body.kyc.identity.city.placeholder': 'Your city',
    'page.body.kyc.identity.postcode.placeholder': 'Your Postcode',
